...
public class CompiledMangoJavaScript {
     ...
     * @throws ScriptPermissionsException
     */
    public MangoJavaScriptResult execute(long runtime, long timestamp, DataType resultDataType) throws ScriptError, ResultTypeException, ScriptPermissionsException {
        Assert.notNull(compiledScript, "Script must be compiled first");
